          ...
          <Container className="mt-16 bg-slate-800 p-8">
            <Section className="">
              ...
              <Text className="text-lg leading-6 text-white">
                A MyBPHS a Budapest School JPP digitális rendszere, ahol:
              </Text>
              <Section className="ml-4">
                ...
                <Text className="text-base leading-6 text-white">
                  • Iskolai jelszavadat módosíthatod (Laptop és WiFi
                  bejelentkezéshez)
                </Text>
                <Text className="text-base leading-6 text-white">
                  • Chatelhetsz a MyBPHS Intelligence ✨ AI-jal
                </Text>
              </Section>
              ...
              <Text className="text-lg leading-6 text-white">
                Ha bármilyen kérdésed van, fordulj bizalommal a rendszergazda
                csapathoz.
              </Text>
