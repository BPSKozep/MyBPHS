          ...
          <Container className="mt-16 bg-slate-800 p-8">
            <Section className="">
              ...
              <Text className="text-lg leading-6 text-white">
                Az email címed megerősítéséhez kérjük, add meg az alábbi
                verifikációs kódot:
              </Text>
              ...
              <Text className="text-lg leading-6 text-white">
                Ez a kód 10 percig érvényes. Ha nem te kérted ezt a
                verifikációt, kérjük, hagyd figyelmen kívül ezt az emailt.
              </Text>
