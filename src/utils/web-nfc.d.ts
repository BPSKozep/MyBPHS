...
/** biome-ignore-all lint/correctness/noUnusedVariables: web-nfc util */
/** biome-ignore-all lint/suspicious/noExplicitAny: web-nfc util */
interface Window {
...
declare class NDEFReader extends EventTarget {
  ...
  addEventListener(type: "readingerror", listener: (event: Event) => any): void;
  removeEventListener(
    type: "reading",
    listener: (event: NDEFReadingEvent) => any,
  ): void;
